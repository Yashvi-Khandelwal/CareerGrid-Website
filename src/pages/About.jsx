    ...
    return(
       <section className="about-container">
        <div className="about-hero-section">
            <h1>About CareerGrid</h1>
            <p>A platform built to simplify your career journey with clarity, guiding you with templates, insights, and opportunities to move forward with confidence.</p>
        </div>
        ...
        <div className="about-story">
            ...
            <div className="my-image">
                <img src="./Yashvi_Khandelwal.jpg" alt="pic" />
            </div>
        </div>
        <div className="punchLine">
            <p>CareerGrid is here to simplify your journey. Explore the templates, check out companies, and take confident steps toward your career goals.</p>
        </div>
       </section>
    )
}